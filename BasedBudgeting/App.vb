...
Public Class App
    ...
    'Dim Dark As Color = Color.FromArgb(40, 40, 40)                                             ' Dark Mode - See NavButtons - dgvBudget_formatting - pbDarkMode
    ...
    Private Sub btnAddCategory_Click(sender As Object, e As EventArgs) Handles btnAddCategory.Click ' Add category at end of dgvBudget
        ...
        If strCat = "" Then                                                                     ' If no input or canceled
            MsgBox("No category name given")
            Exit Sub
        End If
        ...
        If accounts(0) <> "" Then                                                               ' If answer is canceled. Do nothing
            ...
            While valid = False
                ...
                If IsNumeric(accounts(1)) Then
                    ...
                    SaveAccounts()
                    valid = True
                ElseIf accounts(1) = "" Then                                                    ' Check if input is canceled
                    Exit Sub
                Else
    ...
    Private Sub dgvBudget_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvBudget.CellEndEdit  ' Used to automatically add rows in dgvBudget and update total available
        If dgvBudget.CurrentCell.ColumnIndex = 0 Then
            For Each row As DataGridViewRow In dgvBudget.Rows                                   ' If subcategory already exists, don't add it
                If dgvBudget.CurrentCell.Value.ToString = row.Cells(0).Value.ToString And dgvBudget.CurrentRow.Index <> row.Index Then
    ...
    Private Sub checkCombobox()
        ...
        cbAccountFilter.Items.Add("")
        cbPayeeFilter.Items.Add("")
        cbCategoryFilter.Items.Add("To Be Budgeted")                                            ' Add items to combobox of filter
        cbCategoryFilter.Items.Add("Transfer")
        cbCategoryFilter.Items.Add("")
        cbSubcategoryFilter.Items.Add("No Subcategory")
        cbSubcategoryFilter.Items.Add("")
    End Sub
    ...
    '        cbAccount.ForeColor = Color.White
    ...
    '        cbSubcategory.ForeColor = Color.White
    ...
    '        cbAccount.ForeColor = darkerBlue
